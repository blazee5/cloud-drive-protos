...
type AuthServiceClient interface {
	...
	ValidateUser(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *authServiceClient) ValidateUser(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, AuthService_ValidateUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	ValidateUser(context.Context, *TokenRequest) (*UserResponse, error)
...
func (UnimplementedAuthServiceServer) ValidateUser(context.Context, *TokenRequest) (*UserResponse, error) {
...
func _AuthService_ValidateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ValidateUser(ctx, req.(*TokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
